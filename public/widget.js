 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="storeseo" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "storeseo";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "storeseo") + "_chat_session";
